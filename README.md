...
|---------------------------|--------------------------------------------------------------------|-----------------------------|---------------------------|
| **Сбор данных** | Сбор данных с трех веб-сайтов, сохранение в формате CSV.          | Python, Selenium, bs4, pandas, re       | [Код для скрапинга](#)    |
| **Обработка данных**      |Слияние и очистка данных, нахождение выгодных сделок, генерация 150 URL предметов для покупки, скрапинг данных с историей продаж по этим URL, формирование окончательного списка | Pandas, NumPy, Selenium, bs4, re,               | [Код обработки](#)        |
