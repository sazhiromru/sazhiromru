...
- **Настройка ClickHouse для работы с сервером 2ГБ RAM**: Clickhouse не предназначен для работы на небольгих инстансах, поэтому требует тонкой настройки для работоспособности
