...
2. Сервер БД:
   - Receiver Kafka
   - Clickhouse - выбор обусловлен отсутсвием изменений данных, и большим количеством аналитических онлайн запросов для дэшбордв
...
| [**Kafka**](https://github.com/sazhiromru/scraper/blob/main/README.md#Docker-section)                | Настройка Kafka для передачи данных в Clickhouse                       | Kafka                                                      |
