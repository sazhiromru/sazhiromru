...
| [**Обработка данных**](https://github.com/sazhiromru/scraper/blob/main/README.md#wrangling-section)      | Очистка и анализ данных, нахождение выгодных сделок, проверка истории продаж для 150 лучших предметов для верификации данных, формирование итогового списка рекомендаций. Удаление устаревших файлов | Pandas, NumPy, Selenium, Beautiful Soup, re |   
